...
import com.developer.ashishtech.statussaver.Adapters.Fragement_Adapter2;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            viewPager.setAdapter(new Fragement_Adapter2(getSupportFragmentManager()));
        ...
        resultDrawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withSelectable(false).withName("WhatsApp").withIcon(R.drawable.whatsapp_fill).withOnDrawerItemClickListener((view, position, drawerItem) -> {
                            try{
                        ...
                        ,new PrimaryDrawerItem().withSelectable(false).withName("Privacy Policy").withOnDrawerItemClickListener((view, position, drawerItem) -> {
                            ...
                            textView.setScroller(new Scroller(MainActivity2.this));
    ...
    private boolean getAppIntro(MainActivity2 mainActivity) {
